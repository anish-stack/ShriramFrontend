      ...
      <section className='refund-section'>
        <div className='container'>
            <div className='heading'>
                <span>
                Cancellation / Refund return policies
                </span>
            </div>

            <div className='refund-main-box'>
                <p>ShreeRam Garments believes in helping its customers as far as possible and has therefore a liberal cancellation policy. Under this policy:</p>
                ...
                <p>ShreeRam Garments does not accept cancellation requests for perishable items like flowers, eatables, etc. However, a refund/replacement can be made if the customer establishes that the quality of the product delivered is not good.</p>
                ...
                <p>In case of any Refunds approved by ShreeRam Garments, it’ll take 6-8 days for the refund to be processed to the end customer.</p>
            </div>
        </div>
      </section>
    </>
